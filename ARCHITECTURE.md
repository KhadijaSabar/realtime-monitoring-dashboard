...
## 8. Fonctionnalités par Priorité

### MVP (Minimum Viable Product) - Semaine 1
- Collecte métriques (CPU, RAM, Disk) avec Python
- API REST pour recevoir et stocker métriques
- WebSocket pour broadcast temps réel
- Dashboard React avec 3 graphiques en temps réel
- Historique sur les dernières 24h
- Un seul serveur supporté

### Version 1.1 - Semaine 2 (si temps)
- Support multi-serveurs
- Alertes visuelles (seuils configurables)
- Export des données (CSV)
- Graphiques historiques avec zoom
- Dark mode
- Responsive design parfait

### Version 2.0 - Futur (après recherche d'emploi)
...
Pour que le projet soit "terminé" et impressionnant :

- Dashboard affiche les métriques en temps réel avec latence < 1s
- Graphiques fluides et animés
- Historique chargeable et navigable
- Alertes visuelles fonctionnelles (rouge si > 80%)
- Code propre et commenté
- README avec screenshots et démo
- Déployé en ligne avec URL publique
- Tests manuels complets (pas de bugs évidents)
...
|--------|--------|----------|
| WebSocket déconnexions fréquentes | Moyen | Implémenter reconnexion automatique |
| Base de données qui grossit trop | Moyen | Politique de rétention (supprimer > 30 jours) |
| Script Python plante | Haut | Gestion d'erreurs robuste + auto-restart |
| Latence trop élevée | Moyen | Optimiser les requêtes SQL, ajouter index |
| Pas le temps de finir tout | Haut | Se concentrer sur MVP uniquement |
